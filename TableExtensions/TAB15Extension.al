tableextension 50105 "QBU G/L AccountExt" extends "G/L Account"
{
  ...
  fields
{
    field(88182;"QBU KPI for HFM-FCCS";Code[20])
    {
    ...
    field(88183;"QBU IC Partner Code Filter";Code[20])
    {
    ...
    field(7174331;"QBU QuoSII Payment Cash";Boolean)
    {
