tableextension 50189 "QBU Sales Header ArchiveExt" extends "Sales Header Archive"
{
  ...
  fields
{
    ...
    field(7207277;"QBU Value Date";Date)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207299;"QBU Payment Bank No.";Code[20])
    {
