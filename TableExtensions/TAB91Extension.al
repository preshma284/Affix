tableextension 50124 "QBU User SetupExt" extends "User Setup"
{
  ...
  fields
{
    field(50000;"QBU Aut. Presupuestos";Boolean)
    {
        DataClassification=ToBeClassified;


    }
    field(50001;"QBU Aut. modif. retencion";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(50002;"QBU Allow G.E.W. Sale mod.";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(50003;"QBU Cancel Measurement";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(50004;"QBU Allow Internal Changes";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(50005;"QBU Open Budgets";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207270;"QBU Jobs Resp. Ctr. Filter";Code[10])
    {
    ...
    field(7207271;"QBU View all Jobs";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207272;"QBU Guarantees Administrator";Boolean)
    {
...
//                                                                 Text002@100000000 :
    ...
    field(7207273;"QBU Change Rctp. Merge";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207274;"QBU Substitute from date";Date)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207275;"QBU Substitute to date";Date)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207276;"QBU See Balance";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207277;"QBU Register in closed period";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207278;"QBU QPR Modify Budgets Status";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207279;"QBU Allow Negative Target";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207280;"QBU Allow Gen. Posted Elec.Payment";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207281;"QBU Can Change Dimensions";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207283;"QBU Allow Delete Job Quotes";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207284;"QBU Use FRI";Option)
    {
    ...
    field(7207285;"QBU Control Contracts";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207286;"QBU Validate Proform";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207287;"QBU Modify Budget Status";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207288;"QBU Modify Quote Status";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207289;"QBU Modify Quote";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207290;"QBU Modify Job Status";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207291;"QBU Modify Job";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207292;"QBU Mark Certifications Invoiced";Boolean)
    {
        DataClassification=ToBeClassified;
