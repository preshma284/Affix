tableextension 50162 "QBU Bank Acc. Reconciliation LineExt" extends "Bank Acc. Reconciliation Line"
{
...
*/
  ...
  fields
{
    field(50001;"QBU Concepto Interbancario";Code[2])
    {
    ...
    field(50002;"QBU Descripcion conc. interbanc.";Text[60])
    {
    ...
    field(50003;"QBU Description 2";Text[50])
    {
        DataClassification=ToBeClassified;
