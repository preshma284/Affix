tableextension 50102 "QBU Country/RegionExt" extends "Country/Region"
{
  ...
  fields
{
    field(7174331;"QBU QuoSII Country Code";Code[20])
    {
    ...
    field(7174332;"QBU QuoSII VAT Reg No. Type";Code[20])
    {
    ...
    field(7174334;"QBU QFA Code ISO 3166-1 Alpha-3";Code[3])
    {
