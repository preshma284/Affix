tableextension 50111 "QBU ItemExt" extends "Item"
{
  ...
  fields
{
    ...
    field(7207270;"QBU Created by PRESTO";Boolean)
    {
    ...
    field(7207271;"QBU Activity Code";Code[20])
    {
    ...
    field(7207272;"QBU Rent Element Code";Code[20])
    {
    ...
    field(7207273;"QBU Rentable";Boolean)
    {
    ...
    field(7207274;"QBU Quantity Planned Purchase";Decimal)
    {
    ...
    field(7207275;"QBU Entry (units)";Decimal)
    {
        FieldClass=FlowField;
    ...
    field(7207276;"QBU Output (units)";Decimal)
    {
        FieldClass=FlowField;
    ...
    field(7207277;"QBU Location Sum Cost Amount";Decimal)
    {
        FieldClass=FlowField;
    ...
    field(7207278;"QBU Location Sum Cost Qty";Decimal)
    {
        FieldClass=FlowField;
    ...
    field(7207279;"QBU Proformable";Boolean)
    {
        DataClassification=ToBeClassified;
...
//                                                               FunctionQB@100000001 :
    ...
    field(7207311;"QBU Created from Master Data";DateTime)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207312;"QBU Updated from Master Data";DateTime)
    {
        DataClassification=ToBeClassified;
...
//                                                                 IdentityManagement@1000 :
    ...
    field(7207499;"QBU Auxiliary Location";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207500;"QBU Allows Deposit";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207501;"QBU Allow Ceded";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207502;"QBU Origen Location Filter";Code[20])
    {
    ...
    field(7207503;"QBU Destination Location Filter";Code[20])
    {
        FieldClass=FlowFilter;
    ...
    field(7207504;"QBU Qty. Ceded";Decimal)
    {
        FieldClass=FlowField;
...
trigger OnValidate();
    ...
    field(7207505;"QBU Plant Item";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207506;"QBU Main Location";Code[20])
    {
        FieldClass=FlowField;
    ...
    field(7207507;"QBU Main Location Cost";Decimal)
    {
        FieldClass=FlowField;
    ...
    field(7207508;"QBU Main Loc. Purch. Average Pr";Decimal)
    {
        DataClassification=ToBeClassified;
