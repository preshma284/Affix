tableextension 50164 "QBU Payment MethodExt" extends "Payment Method"
{
  ...
  fields
{
    field(7174331;"QBU QuoSII Cobro Metalico SII";Boolean)
    {
    ...
    field(7174332;"QBU QuoSII Type SII";Code[20])
    {
...
//                                                                 SalesLine@7174331 :
    ...
    field(7174334;"QBU QFA Payment Means Type";Option)
    {
    ...
    field(7207270;"QBU Requires approval on purchases";Boolean)
    {
    ...
    field(7207271;"QBU Convert in Payment Relation";Code[10])
    {
    ...
    field(7207272;"QBU Mandatory Vendor Bank";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207273;"QBU % Discount in Proforms";Decimal)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207274;"QBU Confirming Customer";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207275;"QBU Confirming Vendor";Boolean)
    {
        DataClassification=ToBeClassified;
