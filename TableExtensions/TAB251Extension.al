tableextension 50157 "QBU Gen. Product Posting GroupExt" extends "Gen. Product Posting Group"
{
  ...
  fields
{
    field(7174331;"QBU QuoSII Type";Option)
    {
    ...
    field(7174332;"QBU QuoSII IRPF Type";Boolean)
    {
