tableextension 50119 "QBU Invoice Post. BufferExt" extends "Invoice Post. Buffer"
{
...
*/
  ...
  fields
{
    field(50000;"QBU Texto";Text[100])
    {
    ...
    field(7174361;"QBU DP Prorrata %";Decimal)
    {
        DataClassification=ToBeClassified;
    ...
    field(7174362;"QBU DP Non Deductible %";Decimal)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207270;"QBU Location Code";Code[20])
    {
    ...
    field(7207271;"QBU Job Task No.";Code[20])
    {
    ...
    field(7207272;"QBU Piecework Code";Code[20])
    {
