tableextension 50114 "QBU Sales LineExt" extends "Sales Line"
{
  ...
  fields
{
    field(50001;"QBU Price review line";Boolean)
    {
    ...
    field(50003;"QBU Do not print";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7174331;"QBU QuoSII Situacion Inmueble";Code[2])
    {
    ...
    field(7174332;"QBU QuoSII Referencia Catastral";Code[25])
    {
...
//                                                                 SalesLine@7174331 :
    ...
    field(7207270;"QBU QW % Withholding by GE";Decimal)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207271;"QBU QW Withholding Amount by GE";Decimal)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207272;"QBU QW % Withholding by PIT";Decimal)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207273;"QBU QW Withholding Amount by PIT";Decimal)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207274;"QBU Certification code";Code[20])
    {
        DataClassification=ToBeClassified;
    ...
    field(7207275;"QBU Certification Line No.";Integer)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207276;"QBU OLD_Certification Piecework No";Code[20])
    {
    ...
    field(7207277;"QBU Milestone No.";Code[10])
    {
        DataClassification=ToBeClassified;
    ...
    field(7207278;"QBU Usage Document";Code[20])
    {
        DataClassification=ToBeClassified;
    ...
    field(7207279;"QBU Usage Document Line";Integer)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207280;"QBU Temp Job No";Code[20])
    {
        DataClassification=ToBeClassified;
    ...
    field(7207281;"QBU Temp Dimension Set ID";Integer)
    {
...
trigger OnLookup();
    ...
    field(7207282;"QBU Prepayment Line";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207283;"QBU QW Not apply Withholding by GE";Boolean)
    {
...
//                                                                 Withholdingtreating@100000000 :
    ...
    field(7207284;"QBU QW Not apply Withholding PIT";Boolean)
    {
...
//                                                                 Withholdingtreating@100000000 :
    ...
    field(7207285;"QBU QW Base Withholding by GE";Decimal)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207286;"QBU QW Base Withholding by PIT";Decimal)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207287;"QBU QW Withholding by GE Line";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7238177;"QBU Piecework No.";Text[20])
    {
        TableRelation="Data Piecework For Production"."Piecework Code" WHERE ("Job No."=FIELD("Job No."));
...
//                                                                 InventoryPostingSetup@1100286006 :
    ...
    field(7238178;"QBU Job No. QB";Code[20])
    {
        TableRelation="Job";
                                                   DataClassification=ToBeClassified;
