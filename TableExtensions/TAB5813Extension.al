tableextension 50201 "QBU Inventory Posting SetupExt" extends "Inventory Posting Setup"
{
  ...
  fields
{
    field(7207270;"QBU Analytic Concept";Code[20])
    {
...
//                                                               FunctionQB@100000000 :
    ...
    field(7207271;"QBU App. Account Concept Analytic";Code[20])
    {
        TableRelation="Dimension Value"."Code";
...
//                                                               FunctionQB@1100286000 :
    ...
    field(7207272;"QBU Location Account Consumption";Text[20])
    {
    ...
    field(7207273;"QBU App.Account Locat Acc. Consum.";Text[20])
    {
        TableRelation="G/L Account";
