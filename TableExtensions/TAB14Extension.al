tableextension 50104 "QBU LocationExt" extends "Location"
{
  ...
  fields
{
    field(7207270;"QBU Departament Code";Code[20])
    {
...
//                                                               QBTablePublisher@100000000 :
    ...
    field(7207271;"QBU Job Location";Boolean)
    {
    ...
    field(7207272;"QBU Allow Deposit";Boolean)
    {
...
trigger OnValidate();
    ...
    field(7207273;"QBU Allow Ceded";Boolean)
    {
...
trigger OnValidate();
    ...
    field(7207274;"QBU Main Location";Boolean)
    {
...
//                                                                 Location@1100286000 :
    ...
    field(7207275;"QBU View Item Disponibility";Boolean)
    {
        DataClassification=ToBeClassified;
