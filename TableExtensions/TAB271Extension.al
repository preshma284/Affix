tableextension 50160 "QBU Bank Account Ledger EntryExt" extends "Bank Account Ledger Entry"
{
  ...
  fields
{
    field(7207270;"QBU Liquidity Account No.";Code[20])
    {
    ...
    field(7207271;"QBU Value Date";Date)
    {
