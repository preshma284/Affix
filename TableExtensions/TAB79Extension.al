tableextension 50120 "QBU Company InformationExt" extends "Company Information"
{
  ...
  fields
{
    field(7174331;"QBU QuoSII Activate";Boolean)
    {
    ...
    field(7174332;"QBU QuoSII Nos. Serie SII";Code[20])
    {
    ...
    field(7174333;"QBU QuoSII Export SII Path";Text[250])
    {
    ...
    field(7174334;"QBU QuoSII VAT Reg. No. Repres.";Text[250])
    {
        DataClassification=ToBeClassified;
    ...
    field(7174335;"QBU QuoSII VAT Type";Code[20])
    {
    ...
    field(7174336;"QBU QuoSII Day Periodo Purchase";Integer)
    {
        DataClassification=ToBeClassified;
    ...
    field(7174337;"QBU QuoSII Not Use Shipment Date";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7174338;"QBU QuoSII Server WS";Text[50])
    {
        DataClassification=ToBeClassified;
    ...
    field(7174339;"QBU QuoSII Port WS";Text[6])
    {
        DataClassification=ToBeClassified;
    ...
    field(7174340;"QBU QuoSII Instance WS";Text[50])
    {
        DataClassification=ToBeClassified;
    ...
    field(7174341;"QBU QuoSII First date";Date)
    {
        DataClassification=ToBeClassified;
    ...
    field(7174342;"QBU QuoSII User WS";Text[30])
    {
        DataClassification=ToBeClassified;
    ...
    field(7174343;"QBU QuoSII Pass WS";Text[100])
    {
    ...
    field(7174344;"QBU QuoSII Domain WS";Text[30])
    {
        DataClassification=ToBeClassified;
    ...
    field(7174345;"QBU QuoSII REAGYP %";Decimal)
    {
        DataClassification=ToBeClassified;
    ...
    field(7174346;"QBU QuoSII Version";Option)
    {
    ...
    field(7174347;"QBU QuoSII Email From";Text[50])
    {
        DataClassification=ToBeClassified;
                                                   Description='QuoSII';
    ...
    field(7174348;"QBU QuoSII Email To";Text[50])
    {
        DataClassification=ToBeClassified;
                                                   Description='QuoSII';
    ...
    field(7174349;"QBU QuoSII Use Server DLL";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7174350;"QBU QuoSII Certificate";BLOB)
    {
        DataClassification=ToBeClassified;
                                                   Description='QuoSII';
    ...
    field(7174351;"QBU QuoSII Certificate Password";BLOB)
    {
        DataClassification=ToBeClassified;
                                                   Description='QuoSII';
    ...
    field(7174352;"QBU QuoSII Purch. Invoices Period";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7174353;"QBU QuoSII Inclusion Date";Date)
    {
        DataClassification=ToBeClassified;
    ...
    field(7174354;"QBU QuoSII Ignore Messages";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7174355;"QBU QuoSII Use Auto Date";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7174356;"QBU QuoSII Use SSL";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7174357;"QBU QuoSII Send Queue Type";Option)
    {
    ...
    field(7174358;"QBU QuoSII Send Default Type";Option)
    {
        OptionMembers="Real","Pruebas";DataClassification=ToBeClassified;
    ...
    field(7174359;"QBU QuoSII Admin";Text[50])
    {
    ...
    field(7174360;"QBU QuoSII Dimension Job";Code[20])
    {
    ...
    field(7174361;"QBU QuoSII Purch.Operation Date";Option)
    {
