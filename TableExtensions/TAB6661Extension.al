tableextension 50205 "QBU Return Receipt LineExt" extends "Return Receipt Line"
{
...
*/
  ...
  fields
{
    field(7207270;"QBU QW % Withholding by G.E";Decimal)
    {
    ...
    field(7207271;"QBU QW Withholding Amount by G.E";Decimal)
    {
        DataClassification=ToBeClassified;
...
trigger OnLookup();
    ...
    field(7207285;"QBU QW Base Withholding by G.E";Decimal)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207287;"QBU QW Withholding by G.E Line";Boolean)
    {
        DataClassification=ToBeClassified;
