table 7207384 "QBU Bill of Item Data"
{
    ...
    fields
    {
        ...
        field(2; "Type"; Option)
        {
            OptionMembers = "Account","Resource","Resource Group","Item","Posting U.","Percentage","Undefined";
            CaptionML = ENU = 'Cost Type', ESP = 'Tipo L�nea';
            OptionCaptionML = ENU = 'Account,Resource,Resource Group,Item,Posting U.,Percentage,,,,,Undefined', ESP = 'Cuenta,Recurso,Familia,Producto,U. Auxiliar,Porcentual,,,,,No definido';
        ...
        field(67; "Diferencia"; Boolean)
        {
            DataClassification = ToBeClassified;
            Description = 'Q18285 AML 24/03/23';
            Editable = false;


        }
        field(500; "Factor"; Decimal)
        {
            DataClassification = ToBeClassified;
            Description = 'Q18285 AML 24/03/23 Aqui guardamos el factor original';


        }
        field(501; "Factor UO"; Decimal)
        {
            DataClassification = ToBeClassified;
            Description = 'Q18285 AML 24/03/23 Aqui guardamos el factor original';
        ...
        field(502; "Rendimiento Original"; Decimal)
        {
            DataClassification = ToBeClassified;
            Editable = false;
    ...
    keys
    {
        key(key1; "Cod. Cost database", "Cod. Piecework", "Order No.", "Use", "Type", "No.")
        {
            SumIndexFields = "Piecework Cost";
            Clustered =true;
        }
        key(key2; Type)
        {
...
//
//      IMPORTANTE: Esta tabla tiene una gemela en la 7207398, se usa para guardar datos en las agrupaciones, si se cambia algo en esta hay que hacerlo en la complementaria
//    }
    end.
  */
}
