query 50110 "QB BI FactCompraLinea"
{
    ...
    elements
    {
        ...
        DataItem("Purch_Inv_Line"; "Purch. Inv. Line")
        {
            ...
            Column("ECDifference"; "EC Difference")
            {

            }
            Column("QWWithholdingbyGE"; "QW % Withholding by GE")
            {

            }
            Column("QWWithholdingAmountbyGE"; "QW Withholding Amount by GE")
            {

            }
            Column("QWWithholdingbyPIT"; "QW % Withholding by PIT")
            {

            }
            Column("QWWithholdingAmountbyPIT"; "QW Withholding Amount by PIT")
            {
            ...
            Column("QtytoReceiveOrigin"; "Qty. to Receive Origin")
            {

            }
            Column("Accounted"; "Accounted")
            {

            }
            Column("Updatedbudget"; "Updated budget")
            {

            }
            Column("QWNotapplyWithholdingGE"; "QW Not apply Withholding GE")
            {

            }
            Column("QWNotapplyWithholdingPIT"; "QW Not apply Withholding PIT")
            {

            }
            Column("QWBaseWithholdingbyGE"; "QW Base Withholding by GE")
            {

            }
            Column("QWBaseWithholdingbyPIT"; "QW Base Withholding by PIT")
            {

            }
            Column("QWWithholdingbyGELine"; "QW Withholding by G.E Line")
            {

            }
            Column("ReceivedonFRIïS"; "Received on FRIÃ¯S")
            {

            }
            Column("JobCurrencyAmount"; "Job Currency Amount")
            {

            }
            Column("JobCurrencyExchangeRate"; "Job Currency Exchange Rate")
            {

            }
            Column("AditionalCurrencyAmount"; "Aditional Currency Amount")
            {

            }
            Column("AditionalCurrExchangeRate"; "Aditional Curr. Exchange Rate")
            {

            }
            Column("QBFrameworkContrNo"; "QB Framework Contr. No.")
            {

            }
            Column("QBFrameworkContrLine"; "QB Framework Contr. Line")
            {
