tableextension 50153 "MyExtension50153" extends "Job Posting Group"
{
  ...
  fields
{
    field(7207270;"Sales Analytic Concept";Code[20])
    {
...
//                                                               FunctionQB@100000000 :
    ...
    field(7207271;"Income Account Job in Progress";Code[20])
    {
    ...
    field(7207272;"CA Income Job in Progress";Code[20])
    {
        TableRelation="Dimension Value"."Code";
...
//                                                               FunctionQB@100000000 :
    ...
    field(7207273;"Cont. Acc. Job in Progress(+)";Code[20])
    {
        TableRelation="G/L Account";
    ...
    field(7207274;"Cont. Acc. Job in Progress(-)";Code[20])
    {
        TableRelation="G/L Account";
                                                   CaptionML=ENU='Cont. Acc. Job in Progress(-)',ESP='Cta. contr. obra en curso(-)';
                                                   Description='QB24111';
    ...
    field(7207275;"QB Invoice Certi. Type";Option)
    {
    ...
    field(7207276;"QB Invoice Certi. No.";Code[20])
    {
    ...
    field(7207278;"QB Invoice Acc. Service Order";Code[20])
    {
        TableRelation="G/L Account";
                                                   DataClassification=ToBeClassified;
