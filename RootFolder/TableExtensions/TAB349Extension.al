tableextension 50174 "MyExtension50174" extends "Dimension Value"
{
  ...
  fields
{
    field(7174350;"DP Prorrata Non deductible";Boolean)
    {
    ...
    field(7207271;"Jobs desviation";Code[20])
    {
    ...
    field(7207272;"Jobs Not Assigned";Code[20])
    {
        TableRelation=Job WHERE ("Status"=CONST("Open"),
                                                                            "Blocked"=CONST(" "));
    ...
    field(7207273;"Account Budget E Reestimations";Text[20])
    {
    ...
    field(7207274;"Income by Transfer Job";Code[20])
    {
        TableRelation=Job WHERE ("Status"=CONST("Open"),
                                                                            "Blocked"=CONST(" "));
    ...
    field(7207275;"Transfer Analytical Concept";Code[20])
    {
...
//                                                               FunctionQB@1100286000 :
    ...
    field(7207276;"Transfer Account";Code[20])
    {
    ...
    field(7207277;"Job Structure Warehouse";Code[20])
    {
        TableRelation=Job WHERE ("Status"=CONST("Open"),
                                                                            "Blocked"=CONST(" "),
    ...
    field(7207279;"Job Filter";Code[20])
    {
    ...
    field(7207280;"Reestimation Date";Date)
    {
    ...
    field(7207281;"Cash MGT Rule Code";Code[10])
    {
    ...
    field(7207282;"VAT Prod. Posting Group";Code[20])
    {
    ...
    field(7207283;"QB Department";Code[20])
    {
