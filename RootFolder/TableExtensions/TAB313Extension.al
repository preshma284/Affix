tableextension 50167 "MyExtension50167" extends "Inventory Setup"
{
...
*/
  ...
  fields
{
    field(7207270;"OLD_Output Ship.Post Serie No.";Code[10])
    {
    ...
    field(7207271;"OLD_Stock Regulariz.Serie No.";Code[10])
    {
        TableRelation="No. Series";
    ...
    field(7207272;"OLD_Output Ship. Serie No.";Code[10])
    {
        TableRelation="No. Series";
