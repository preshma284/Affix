tableextension 50151 "MyExtension50151" extends "Resource Cost"
{
  ...
  fields
{
    field(7207270;"C.A. Direct Cost Allocation";Code[20])
    {
...
//                                                               FunctionQB@100000002 :
    ...
    field(7207271;"Acc. Direct Cost Allocation";Code[20])
    {
    ...
    field(7207272;"C.A. Direct Cost Appl. Account";Code[20])
    {
        TableRelation="Dimension Value"."Code";
...
//                                                               FunctionQB@1100286000 :
    ...
    field(7207273;"Acc. Direct Cost Appl. Account";Code[20])
    {
        TableRelation="G/L Account";
    ...
    field(7207274;"C.A. Indirect Cost Allocation";Code[20])
    {
        TableRelation="Dimension Value"."Code";
...
//                                                               FunctionQB@1100286000 :
    ...
    field(7207275;"Acc. Indirect Cost Allocation";Code[20])
    {
        TableRelation="G/L Account";
    ...
    field(7207276;"C.A. Ind. Cost Appl. Account";Code[20])
    {
        TableRelation="Dimension Value"."Code";
...
//                                                               FunctionQB@1100286000 :
    ...
    field(7207277;"Acc. Ind. Cost Appl. Account";Code[20])
    {
        TableRelation="G/L Account";
