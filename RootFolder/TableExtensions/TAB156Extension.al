tableextension 50144 "MyExtension50144" extends "Resource"
{
  ...
  fields
{
    ...
    field(7207270;"Jobs Deviation";Code[20])
    {
    ...
    field(7207271;"Jobs Not Assigned";Code[20])
    {
        TableRelation="Job";
    ...
    field(7207272;"Type Calendar";Code[10])
    {
    ...
    field(7207273;"Cod. Type Jobs not Assigned";Code[10])
    {
    ...
    field(7207274;"Activity Code";Code[20])
    {
    ...
    field(7207275;"Created by PRESTO S/N";Boolean)
    {
    ...
    field(7207276;"Cod. C.A. Indirect Costs";Code[20])
    {
...
//                                                               FunctionQB@100000001 :
    ...
    field(7207277;"Cod. Type Depreciation Jobs";Code[10])
    {
        TableRelation="Work Type";
    ...
    field(7207278;"Potency (PH)";Decimal)
    {
    ...
    field(7207279;"Actual Cost";Decimal)
    {
    ...
    field(7207280;"Usage (ITS/HR x HP)";Decimal)
    {
    ...
    field(7207281;"Cod. C.A. Direct Costs";Code[20])
    {
        TableRelation="Dimension Value"."Code";
...
//                                                               FunctionQB@100000001 :
    ...
    field(7207282;"QB Proformable";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207498;"Data Missed Old Blocked";Boolean)
    {
