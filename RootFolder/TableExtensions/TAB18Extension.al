tableextension 50107 "MyExtension50107" extends "Customer"
{
...
*/DataCaptionFields="No.","Name";
  ...
  fields
{
    field(50000;"Several Customer";Boolean)
    {
...
trigger OnValidate();
    ...
    field(50001;"Secondary Holder";Code[20])
    {
    ...
    field(50002;"Secondary Holder Name";Text[50])
    {
    ...
    field(7174338;"QuoSII Sales Special R. ATCN";Code[20])
    {
        TableRelation="SII Type List Value"."Code" WHERE ("Type"=CONST("KeySpecialSalesInv"),
    ...
    field(7174339;"QuoSII Sales Special R. 1 ATCN";Code[20])
    {
        TableRelation="SII Type List Value"."Code" WHERE ("Type"=CONST("KeySpecialSalesInv"),
                                                                                                   "SII Entity"=CONST('ATCN'));
    ...
    field(7174340;"QuoSII Sales Special R. 2 ATCN";Code[20])
    {
        TableRelation="SII Type List Value"."Code" WHERE ("Type"=CONST("KeySpecialSalesInv"),
                                                                                                   "SII Entity"=CONST('ATCN'));
    ...
    field(7174365;"QFA Quofacturae endpoint";Code[20])
    {
    ...
    field(7207270;"QW Withholding Group by GE";Code[20])
    {
    ...
    field(7207271;"QW Withholding Group by PIT";Code[20])
    {
    ...
    field(7207273;"QW Withholding Pending GE";Decimal)
    {
        FieldClass=FlowField;
                                                   CalcFormula=Sum("Withholding Movements"."Amount" WHERE ("Type"=CONST("Customer"),
                                                                                                         "No."=FIELD("No."),
    ...
    field(7207274;"QB Establishment Date";Date)
    {
    ...
    field(7207275;"QB Before The Notary";Text[50])
    {
    ...
    field(7207276;"QB Protocol No.";Text[30])
    {
    ...
    field(7207277;"QB Commercial Register";Text[100])
    {
    ...
    field(7207278;"QB JV Dimension Code";Code[20])
    {
...
//                                                               QBTablePublisher@100000000 :
    ...
    field(7207279;"QB Customer Type";Code[20])
    {
    ...
    field(7207280;"QB First Surname";Text[30])
    {
    ...
    field(7207281;"QB Second Surname";Text[30])
    {
    ...
    field(7207283;"QB Generic Customer";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207284;"QB Category";Code[20])
    {
...
trigger OnValidate();
    ...
    field(7207285;"QB Referring of Customer";Code[20])
    {
...
//                                                                 FunctionQB@1100286001 :
    ...
    field(7207286;"QB Representative 1";Code[20])
    {
...
//                                                               TempCust@100000000 :
    ...
    field(7207287;"QB Representative 1 Name";Text[50])
    {
        FieldClass=FlowField;
    ...
    field(7207288;"QB Representative 2";Code[20])
    {
        TableRelation="Contact";
...
//                                                               TempCust@100000000 :
    ...
    field(7207289;"QB Representative 2 Name";Text[50])
    {
        FieldClass=FlowField;
    ...
    field(7207292;"QB Third No.";Code[20])
    {
