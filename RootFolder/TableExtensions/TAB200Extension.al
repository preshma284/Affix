tableextension 50149 "MyExtension50149" extends "Work Type"
{
  ...
  fields
{
    field(7207270;"Compute Hours";Boolean)
    {
        CaptionML=ENU='Compute Hours',ESP='Computa para horas';


    }
    field(7207271;"C.A. Direct Cost Allocation";Code[20])
    {
...
//                                                               FunctionQB@100000000 :
    ...
    field(7207272;"Acc. Direct Cost Allocation";Code[20])
    {
    ...
    field(7207273;"C.A. Direct Cost App. Account";Code[20])
    {
        TableRelation="Dimension Value"."Code";
...
//                                                               FunctionQB@1100286000 :
    ...
    field(7207274;"Acc. Direct Cost App. Account";Code[20])
    {
        TableRelation="G/L Account";
    ...
    field(7207275;"C.A. Indirect Cost Allocation";Code[20])
    {
        TableRelation="Dimension Value"."Code";
...
//                                                               FunctionQB@1100286000 :
    ...
    field(7207276;"Acc. Indirect Cost Allocation";Code[20])
    {
        TableRelation="G/L Account";
    ...
    field(7207277;"C.A. Indirect Cost App. Accoun";Code[20])
    {
        TableRelation="Dimension Value"."Code";
...
//                                                               FunctionQB@1100286000 :
    ...
    field(7207278;"Acc. Indirect Cost App. Accoun";Code[20])
    {
        TableRelation="G/L Account";
    ...
    field(7207279;"Salary Concept";Code[20])
    {
