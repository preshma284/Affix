tableextension 50110 "MyExtension50110" extends "Vendor Ledger Entry"
{
  ...
  fields
{
    field(50000;"En Relaci¢n de efectos";Integer)
    {
    ...
    field(50001;"Several Vendors Name";Text[50])
    {
    ...
    field(50002;"Several Vendors VAT Reg. No.";Text[20])
    {
        DataClassification=CustomerContent;
    ...
    field(50003;"Fecha Recepci¢n";Date)
    {
    ...
    field(7174332;"QuoSII Purch. Invoice Type";Code[20])
    {
    ...
    field(7174333;"QuoSII Purch. Corr. Inv. Type";Code[20])
    {
        TableRelation="SII Type List Value"."Code" WHERE ("Type"=CONST("PurchInvType"),
                                                                                                   "SII Entity"=FIELD("QuoSII Entity"));
    ...
    field(7174334;"QuoSII Purch. Cr.Memo Type";Code[20])
    {
    ...
    field(7174335;"QuoSII Purch. Special Reg.";Code[20])
    {
    ...
    field(7174336;"QuoSII Purch. Special Reg. 1";Code[20])
    {
        TableRelation="SII Type List Value"."Code" WHERE ("Type"=CONST("KeySpecialPurchInv"),
                                                                                                   "SII Entity"=FIELD("QuoSII Entity"));
    ...
    field(7174337;"QuoSII Purch. Special Reg. 2";Code[20])
    {
        TableRelation="SII Type List Value"."Code" WHERE ("Type"=CONST("KeySpecialPurchInv"),
                                                                                                   "SII Entity"=FIELD("QuoSII Entity"));
    ...
    field(7174338;"QuoSII Purch. UE Inv Type";Code[20])
    {
    ...
    field(7174339;"QuoSII UE Country";Code[10])
    {
    ...
    field(7174340;"QuoSII Bienes Description";Text[40])
    {
    ...
    field(7174341;"QuoSII Operator Address";Text[120])
    {
    ...
    field(7174342;"QuoSII Medio Pago";Code[20])
    {
    ...
    field(7174343;"QuoSII CuentaMedioPago";Text[34])
    {
        TableRelation="SII Type List Value"."Code" WHERE ("Type"=CONST("PaymentMethod"));
    ...
    field(7174344;"QuoSII Last Ticket No.";Code[20])
    {
    ...
    field(7174345;"QuoSII Third Party";Boolean)
    {
    ...
    field(7174346;"QuoSII AEAT Status";Code[20])
    {
        FieldClass=FlowField;
    ...
    field(7174347;"QuoSII Ship No.";Code[20])
    {
        FieldClass=FlowField;
    ...
    field(7174348;"QuoSII Entity";Code[20])
    {
    ...
    field(7174350;"QuoSII Auto Posting Date";Date)
    {
    ...
    field(7174351;"QuoSII Use Auto Date";Boolean)
    {
    ...
    field(7207271;"QB Job No.";Code[20])
    {
        TableRelation="Job";
    ...
    field(7207272;"QB To Liquidate";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207274;"QB Shipment Remaining Amount";Decimal)
    {
        FieldClass=FlowField;
    ...
    field(7207275;"QB Shipment Remaining Am (LCY)";Decimal)
    {
        FieldClass=FlowField;
    ...
    field(7207276;"QB Vendor Name";Text[50])
    {
        FieldClass=FlowField;
    ...
    field(7207294;"QB Prepayment";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207500;"QB Budget Item";Code[20])
    {
        DataClassification=ToBeClassified;
...
//       EfectoLineas@1100286000 :
    ...
    begin
      //BS::22353 CSM 22/05/24 Í Num Relaci¢n Efecto en Mov Proveedor. -
      NumRel := 0;
...
//      BS::22353 CSM 22/05/24 Í Num Relaci¢n Efecto en Mov Proveedor.  New function.
//    }
    end.
  */
}
