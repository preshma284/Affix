tableextension 50134 "MyExtension50134" extends "Sales Cr.Memo Header"
{
...
//                                                                 SalesLine@7174331 :
    ...
    field(7174333;"QuoSII Sales Cor. Inv. Type";Code[20])
    {
        TableRelation="SII Type List Value"."Code" WHERE ("Type"=CONST("SalesInvType"));
    ...
    field(7174335;"QuoSII Sales UE Inv Type";Code[20])
    {
    ...
    field(7174338;"QuoSII Sales Special Regimen";Code[20])
    {
        TableRelation="SII Type List Value"."Code" WHERE ("Type"=CONST("KeySpecialSalesInv"));
