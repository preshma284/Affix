tableextension 50168 "MyExtension50168" extends "Resources Setup"
{
  ...
  fields
{
    field(7207270;"OLD_Default Calendar";Code[10])
    {
    ...
    field(7207271;"OLD_No. Serie Sheet";Code[10])
    {
    ...
    field(7207272;"OLD_No. Serie Sheet Post.";Code[10])
    {
        TableRelation="No. Series";
