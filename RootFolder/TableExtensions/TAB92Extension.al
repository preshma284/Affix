tableextension 50125 "MyExtension50125" extends "Customer Posting Group"
{
  ...
  fields
{
    field(7174332;"QuoSII Type";Option)
    {
    ...
    field(7174333;"QuoSII Invoice Description";Text[250])
    {
    ...
    field(7207271;"QB Confirming Account";Code[20])
    {
    ...
    field(7207273;"QB Confirming Collection Acc.";Code[20])
    {
        TableRelation="G/L Account";
                                                   DataClassification=ToBeClassified;
