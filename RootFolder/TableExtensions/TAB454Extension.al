tableextension 50178 "MyExtension50178" extends "Approval Entry"
{
  ...
  fields
{
    field(50000;"Fecha Recepci¢n";Date)
    {
    ...
    field(50003;"Journal Line No.";Integer)
    {
        DataClassification=ToBeClassified;
    ...
    field(50004;"Cust/Vendor No.";Code[20])
    {
        DataClassification=ToBeClassified;
    ...
    field(50005;"Cust/Vendor Name";Text[50])
    {
        DataClassification=ToBeClassified;
    ...
    field(50006;"Job Description";Text[50])
    {
    ...
    field(50007;"Piecework Desc.";Text[50])
    {
        FieldClass=FlowField;
    ...
    field(7207270;"Posted Sheet";Boolean)
    {
    ...
    field(7207272;"Payment Terms Code";Code[10])
    {
    ...
    field(7207273;"Payment Method Code";Code[10])
    {
    ...
    field(7207275;"Withholding";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207276;"QB Document Type";Option)
    {
    ...
    field(7207277;"QB Substituted";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207278;"QB Original Approver";Code[50])
    {
        DataClassification=ToBeClassified;
    ...
    field(7207279;"QB Position";Code[10])
    {
