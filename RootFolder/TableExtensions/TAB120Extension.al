tableextension 50136 "MyExtension50136" extends "Purch. Rcpt. Header"
{
  ...
  fields
{
    ...
    field(7207292;"Cancelled";Boolean)
    {
    ...
    field(7207293;"No. Receipt Cancel";Code[20])
    {
    ...
    field(7207330;"QB Have Proforms";Boolean)
    {
    ...
    field(7207333;"QB Total Amount";Decimal)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207334;"QB Invoiced Amount";Decimal)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207335;"QB Accounted Amount";Decimal)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207339;"QB Canceled By";Code[50])
    {
        DataClassification=ToBeClassified;
    ...
    field(7207340;"QB Canceled in Date";Date)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207341;"QB Canceled With Date";Date)
    {
        DataClassification=ToBeClassified;
