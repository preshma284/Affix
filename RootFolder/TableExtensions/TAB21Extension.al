tableextension 50108 "MyExtension50108" extends "Cust. Ledger Entry"
{
  ...
  fields
{
    field(50000;"Several Customers Name";Text[50])
    {
    ...
    field(50001;"Several Customers VAT Reg. No.";Text[20])
    {
        DataClassification=ToBeClassified;
    ...
    field(7174333;"QuoSII Sales Corrected In.Type";Code[20])
    {
        TableRelation="SII Type List Value"."Code" WHERE ("Type"=CONST("SalesInvType"),
                                                                                                   "SII Entity"=FIELD("QuoSII Entity"));
    ...
    field(7174342;"QuoSII Medio Cobro";Code[20])
    {
    ...
    field(7174343;"QuoSII CuentaMedioCobro";Text[34])
    {
        TableRelation="SII Type List Value"."Code" WHERE ("Type"=CONST("PaymentMethod"));
    ...
    field(7174346;"QuoSII Situacion Inmueble";Code[2])
    {
    ...
    field(7174347;"QuoSII Referencia Catastral";Code[25])
    {
    ...
    field(7174348;"QuoSII AEAT Status";Code[20])
    {
    ...
    field(7174349;"QuoSII Ship No.";Code[20])
    {
        FieldClass=FlowField;
    ...
    field(7174350;"QuoSII Entity";Code[20])
    {
    ...
    field(7174351;"QuoSII First Ticket No.";Code[20])
    {
    ...
    field(7174377;"QFA Correction Reason Code";Option)
    {
    ...
    field(7174378;"QFA Correction Method Code";Option)
    {
    ...
    field(7174379;"QFA Posting No. Facturae";Text[250])
    {
        FieldClass=FlowField;
    ...
    field(7207271;"QB To Liquidate";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207274;"QB WIP Remaining Amount";Decimal)
    {
        FieldClass=FlowField;
    ...
    field(7207275;"QB WIP Remaining Amt. (LCY)";Decimal)
    {
        FieldClass=FlowField;
    ...
    field(7207276;"QB Customer Name";Text[50])
    {
        FieldClass=FlowField;
    ...
    field(7207277;"Do not sent to SII";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207282;"QB Receivable Bank No.";Code[20])
    {
