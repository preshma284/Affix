tableextension 50172 "MyExtension50172" extends "VAT Posting Setup"
{
  ...
  fields
{
    field(7147400;"QuoSII DUA Compensation";Boolean)
    {
    ...
    field(7174331;"QuoSII Exent Type";Code[20])
    {
    ...
    field(7174332;"QuoSII No VAT Type";Code[20])
    {
    ...
    field(7174390;"DP Non Deductible VAT Line";Boolean)
    {
        DataClassification=ToBeClassified;
    ...
    field(7174391;"DP Non Deductible VAT %";Decimal)
    {
        DataClassification=ToBeClassified;
    ...
    field(7207200;"ISP Description";Text[150])
    {
        DataClassification=ToBeClassified;
