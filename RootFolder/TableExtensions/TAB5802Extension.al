tableextension 50200 "MyExtension50200" extends "Value Entry"
{
  ...
  fields
{
    ...
    field(7207700;"QB Stocks Adjusted GL";Boolean)
    {
        DataClassification=ToBeClassified;
                                                   Description='QB_ST01';
    ...
    field(7207701;"QB Stocks Adjusted Not Found";Boolean)
    {
        DataClassification=ToBeClassified;
                                                   Description='QB_ST01' ;
