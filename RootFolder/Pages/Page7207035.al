page 7207035 "Comparative Quote List Closed"
{
  ApplicationArea=All;
...
CaptionML=ENU='"Comparative Quote" List',ESP='Lista comparativo ofertas';
    ...
    ModifyAllowed=false;
    SourceTable=7207412;
    SourceTableView=WHERE("Comparative Status"=CONST("Closed"));
...
trigger OnAfterGetCurrRecord()    BEGIN
    ...
    begin
    {
      ...
      JAV 02/06/22: - QB 1.10.47 Se a�ade el campo Status. Se filtra que solo sean Cerrados.
    }
    end.*/
