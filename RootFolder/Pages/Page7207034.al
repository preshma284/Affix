page 7207034 "Comparative Quote List Post"
{
  ApplicationArea=All;
...
CaptionML=ENU='"Comparative Quote" List',ESP='Lista comparativo ofertas';
    InsertAllowed=false;
    SourceTable=7207412;
    SourceTableView=WHERE("Comparative Status"=CONST("Generated"));
...
trigger OnAfterGetCurrRecord()    BEGIN
    ...
    begin
    {
      ...
      JAV 02/06/22: - QB 1.10.47 Se a�ade el campo Status. Se filtra que solo sean Generados.
    }
    end.*/
