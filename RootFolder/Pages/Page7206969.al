page 7206969 "QB Liquidate Customer Subform"
{
CaptionML=ENU='Customer Pending Movs',ESP='Movimientos pendientes del Cliente';
    InsertAllowed=false;
    DeleteAllowed=false;
    SourceTable=21;
    PageType=ListPart;
...
group("group94")
{
  ...
  ;
    ...
    begin
      ...
      Customer.RESET;
      Customer.SETRANGE("QB Third No.", Third);
        ...
        repeat
          ...
          if (CustLedgerEntry.FINDSET(FALSE)) then
            repeat
              ...
              Rec.INSERT;
              Rec.CALCFIELDS("Remaining Amount");
              TotalAmount += Rec."Remaining Amount";
