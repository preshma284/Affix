...
area(content)
{
  ...
  /*
    ...
    begin
    {
      ...
      JAV 02/06/19: - Se cambia el campo "Quote Phase" por "Internal Status"
      ...
      PGM 20/09/19: - GAP011 Sacado los campos de "Responsibility Center" y "Customer Type"
      PGM 08/10/19: - GAP015 A�adido los campos "Project Management" y "Project Management Descr."
