page 7207060 "Plan Job Budget Units Matrix"
{
  ...
  ;
    ...
    actions
    {
        area(Processing)
        {
            ...
            action("Set")
            {
                ...
                trigger OnAction()
                VAR
                    TMPExpectedTimeUnitDataTemp: Record 7206942;
                    LJob: Record 167;
                    ExpectedTimeUnitData: Record 7207383;
                    ExpectedTimeUnitDataNewMSP: Record 7207383;
                ...
                BEGIN
                    ...
                    IF CONFIRM(Text010) THEN BEGIN
                        ...
                        IF DataPieceworkForProductionUO.FINDSET THEN
                            REPEAT
                                DataPieceworkForProductionUO.CALCFIELDS("QPR Cost Amount", "QPR Sale Amount");
                                ...
                                IF (NOT TMPExpectedTimeUnitDataTemp.ISEMPTY) THEN BEGIN
                                    TMPExpectedTimeUnitDataTemp.CALCSUMS(TMPExpectedTimeUnitDataTemp."Cost Amount", "Sale Amount");
                                    CASE OptValue OF
                                        OptValue::Gastos:
                                            IF (DataPieceworkForProductionUO."QPR Cost Amount" - TMPExpectedTimeUnitDataTemp."Cost Amount" > Decimales) THEN
                                                ERROR(Text013, DataPieceworkForProductionUO."Piecework Code", DataPieceworkForProductionUO."QPR Cost Amount" - TMPExpectedTimeUnitDataTemp."Cost Amount");
                                        OptValue::Ingresos:
                                            IF (DataPieceworkForProductionUO."QPR Sale Amount" - TMPExpectedTimeUnitDataTemp."Sale Amount" > Decimales) THEN
                                                ERROR(Text013, DataPieceworkForProductionUO."Piecework Code", DataPieceworkForProductionUO."QPR Sale Amount" - TMPExpectedTimeUnitDataTemp."Sale Amount");
                                    END;
                                    ...
                                    CASE OptValue OF
                                        OptValue::Gastos:
                                            ExpectedTimeUnitData.SETRANGE(Type, ExpectedTimeUnitData.Type::Cost);
                                        OptValue::Ingresos:
                                            ExpectedTimeUnitData.SETRANGE(Type, ExpectedTimeUnitData.Type::Sales);
                                    END;
                        ...
                        CASE OptValue OF
                            OptValue::Gastos:
                                TMPExpectedTimeUnitDataTemp.SETFILTER("Cost Amount", '<>0');
                            OptValue::Ingresos:
                                TMPExpectedTimeUnitDataTemp.SETFILTER("Sale Amount", '<>0');
                        END;
                        IF TMPExpectedTimeUnitDataTemp.FINDSET(FALSE) THEN BEGIN
                            REPEAT
                                ...
                                CASE OptValue OF
                                    OptValue::Gastos:
                                        BEGIN
                                            ExpectedTimeUnitDataNewMSP."Sale Amount" := 0;
                                            ExpectedTimeUnitDataNewMSP.Type := ExpectedTimeUnitDataNewMSP.Type::Cost;
                                        END;
                                    OptValue::Ingresos:
                                        BEGIN
                                            ExpectedTimeUnitDataNewMSP."Cost Amount" := 0;
                                            ExpectedTimeUnitDataNewMSP.Type := ExpectedTimeUnitDataNewMSP.Type::Sales;
                                        END;
                                END;
            ...
            action("Adjust")
            {
                ...
                BEGIN
                    ...
                    ELSE BEGIN
                        ...
                        CASE OptValue OF
                            OptValue::Gastos:
                                TMPExpectedTimeUnitData.SETRANGE(Type, TMPExpectedTimeUnitData.Type::Cost);
                            OptValue::Ingresos:
                                TMPExpectedTimeUnitData.SETRANGE(Type, TMPExpectedTimeUnitData.Type::Sales);
                        END;
                        IF (NOT TMPExpectedTimeUnitData.FINDLAST) THEN
                            MESSAGE(Text021)
                        ELSE IF CONFIRM(Text020, TRUE, TMPExpectedTimeUnitData."Expected Date", QuantityBudget - Suma, rec."Unit Of Measure") THEN BEGIN
                            CASE OptValue OF
                                OptValue::Gastos:
                                    TMPExpectedTimeUnitData."Cost Amount" += QuantityBudget - Suma;
                                OptValue::Ingresos:
                                    TMPExpectedTimeUnitData."Sale Amount" += QuantityBudget - Suma;
                            END;
    ...
    var
        ...
        OptValue: Option "Gastos","Ingresos";
        CodeJob: Code[20];
    ...
    procedure Load(var MatrixColumns1: ARRAY[32] OF Text[1024]; var MatrixRecords1: ARRAY[32] OF Record 2000000007; QtyType1: Option "Net Change","Balance at Date",; pCodeJob: Code[20]; pFilterBudget: Code[20]; pColumnSet: Text; pDir: Boolean; pInd: Boolean);
    var
        i: Integer;
    begin
    ...
    begin
        ...
        PAGE.RUNMODAL(PAGE::"QPR TMP Budget Data Amounts", TMPExpectedTimeUnitData);
    end;
    ...
    begin
        ...
        CASE OptValue OF
            OptValue::Gastos:
                exit(TMPExpectedTimeUnitData."Cost Amount");
            OptValue::Ingresos:
                exit(TMPExpectedTimeUnitData."Sale Amount");
        end;
    end;
            ...
            if (TMPExpectedTimeUnitData.FINDSET) then
                repeat
                    ...
                    if (TMPExpectedTimeUnitData."Expected Date" < MatrixRecords[1]."Period Start") then begin
                        CASE OptValue OF
                            OptValue::Gastos:
                                PreviousBalance += TMPExpectedTimeUnitData."Cost Amount";
                            OptValue::Ingresos:
                                PreviousBalance += TMPExpectedTimeUnitData."Sale Amount";
                        end;
                    end;
                    if (TMPExpectedTimeUnitData."Expected Date" > MatrixRecords[LastPeriod]."Period end") then begin
                        CASE OptValue OF
                            OptValue::Gastos:
                                NextBalance += TMPExpectedTimeUnitData."Cost Amount";
                            OptValue::Ingresos:
                                NextBalance += TMPExpectedTimeUnitData."Sale Amount";
                        end;
                    end;

                    CASE OptValue OF
                        OptValue::Gastos:
                            QuantityPlanned += TMPExpectedTimeUnitData."Cost Amount";
                        OptValue::Ingresos:
                            QuantityPlanned += TMPExpectedTimeUnitData."Sale Amount";
                    end;

                    CASE OptValue OF
                        OptValue::Gastos:
                            QuantityBudget += TMPExpectedTimeUnitData."Cost Amount";
                        OptValue::Ingresos:
                            QuantityBudget += TMPExpectedTimeUnitData."Sale Amount";
                    end;
            ...
            CASE OptValue OF
                ...
                OptValue::Gastos:
                    begin
                        ...
                        DataPieceworkForProduction.CALCFIELDS("QPR Cost Amount");
                        QuantityBudget := DataPieceworkForProduction."QPR Cost Amount";
                    end;
                OptValue::Ingresos:
                    begin
                        DataPieceworkForProduction.SETRANGE("Filter Date", 0D, JobBudget."Budget Date" - 1);
                        DataPieceworkForProduction.CALCFIELDS("QPR Sale Amount");
                        QuantityBudget := DataPieceworkForProduction."QPR Sale Amount";
                    end;
            end;
        end;
    ...
    begin
        ...
        if (TMPExpectedTimeUnitData.FINDFIRST) then begin
            ...
            CASE OptValue OF
                OptValue::Gastos:
                    TMPExpectedTimeUnitData.VALIDATE("Cost Amount", ROUND(NewValue, Decimales));
                OptValue::Ingresos:
                    TMPExpectedTimeUnitData.VALIDATE("Sale Amount", ROUND(NewValue, Decimales));
            end;
            ...
            CASE OptValue OF
                OptValue::Gastos:
                    begin
                        TMPExpectedTimeUnitData.VALIDATE("Cost Amount", ROUND(NewValue, Decimales));
                        TMPExpectedTimeUnitData.Type := TMPExpectedTimeUnitData.Type::Cost;
                    end;
                OptValue::Ingresos:
                    begin
                        TMPExpectedTimeUnitData.VALIDATE("Sale Amount", ROUND(NewValue, Decimales));
                        TMPExpectedTimeUnitData.Type := TMPExpectedTimeUnitData.Type::Sales;
                    end;
            end;
    ...
    LOCAL procedure ConfirmAndTtransferToBudget();
    var
        TMPExpectedTimeUnitDataTemp: Record 7206942;
        LJob: Record 167;
        ExpectedTimeUnitData: Record 7207383;
        ...
        TAmount: Decimal;
        JobOVersion: Boolean;
        Text0001: TextConst ENU = 'Transfer completed.', ESP = 'Traspaso completado.';
    begin
        if LJob.GET(CodeJob) then
            LJob.JobStatus(CodeJob);
        ...
        if CONFIRM(Text010) then begin
            ...
            /*{
            CASE OptValue OF
                    OptValue::Gastos: TMPExpectedTimeUnitDataTemp.SETFILTER("Cost Amount", '<>0');
                    OptValue::Ingresos: TMPExpectedTimeUnitDataTemp.SETFILTER("Sale Amount", '<>0');
            end;
            }*/
            if TMPExpectedTimeUnitDataTemp.FINDSET(FALSE) then begin
                repeat
                    if (TMPExpectedTimeUnitDataTemp.Type = TMPExpectedTimeUnitDataTemp.Type::Cost) and (TMPExpectedTimeUnitDataTemp."Cost Amount" <> 0) or
                       (TMPExpectedTimeUnitDataTemp.Type = TMPExpectedTimeUnitDataTemp.Type::Sales) and (TMPExpectedTimeUnitDataTemp."Sale Amount" <> 0) then begin
                        LastEntry += 1;
                        ExpectedTimeUnitDataNewMSP.TRANSFERFIELDS(TMPExpectedTimeUnitDataTemp);
                        ExpectedTimeUnitDataNewMSP."Entry No." := LastEntry;
                        ExpectedTimeUnitDataNewMSP."Budget Code" := FilterBudget;
                        /*{
                        CASE OptValue OF
                            OptValue::Gastos:begin
                               ExpectedTimeUnitDataNewMSP."Sale Amount" := 0;
                               ExpectedTimeUnitDataNewMSP.Type:= ExpectedTimeUnitDataNewMSP.Type::Cost;
                            end;
                            OptValue::Ingresos:begin
                               ExpectedTimeUnitDataNewMSP."Cost Amount":= 0;
                               ExpectedTimeUnitDataNewMSP.Type:= ExpectedTimeUnitDataNewMSP.Type::Sales;
                            end;
                        end;
                        }*/
                        CASE TMPExpectedTimeUnitDataTemp.Type OF
                            TMPExpectedTimeUnitDataTemp.Type::Cost:
                                begin
                                    ExpectedTimeUnitDataNewMSP."Sale Amount" := 0;
                                    ExpectedTimeUnitDataNewMSP.Type := ExpectedTimeUnitDataNewMSP.Type::Cost;
                                end;
                            TMPExpectedTimeUnitDataTemp.Type::Sales:
                                begin
                                    ExpectedTimeUnitDataNewMSP."Cost Amount" := 0;
                                    ExpectedTimeUnitDataNewMSP.Type := ExpectedTimeUnitDataNewMSP.Type::Sales;
                                end;
