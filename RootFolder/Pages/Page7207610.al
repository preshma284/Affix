page 7207610 "Subform Reception Job"
{
    CaptionML = ENU = 'Subform Reception Job', ESP = 'Subform recp. proyecto';
    ...
    actions
    {
        area(Processing)
        {
            ...
            group("group2")
            {
                ...
                action("action1")
                {
                    CaptionML = ENU = 'Autofill Qty. to Receive', ESP = 'Rellenar cdad. a recibir aut.';
                ...
                action("action2")
                {
                    CaptionML = ENU = 'Delete Qty. to Receive', ESP = 'Eliminar cdad. a recibir';
    ...
    begin
        ...
        Rec.AutofillQtyToReceive(LineReceptionJob);
    end;
    ...
    begin
        LineReceptionJob.COPY(Rec);
        Rec.DeleteQtyToReceive(LineReceptionJob);
    end;
