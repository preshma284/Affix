page 7207091 "RE Active List"
{
  ApplicationArea=All;

    Editable = false;
    CaptionML = ENU = 'Real Estate Active List', ESP = 'Lista de Activos Inmobiliarios';
    SourceTable = 167;
    SourceTableView = SORTING("No.")
                    ORDER(Descending)
                    WHERE("Card Type" = FILTER("Promocion"), "Archived" = CONST(false));
    PageType = List;
    CardPageID = "RE Active Card";
