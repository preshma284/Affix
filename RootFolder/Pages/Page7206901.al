page 7206901 "Structure Jobs List"
{
  ApplicationArea=All;

    Editable = false;
    CaptionML = ENU = 'Structure Jobs List', ESP = 'Lista proyectos de estructura';
    SourceTable = 167;
    SourceTableView = SORTING("No.")
                    ORDER(Descending)
                    WHERE("Card Type" = FILTER("Proyecto operativo"), "Job Type" = CONST("Structure"));
    PageType = List;
