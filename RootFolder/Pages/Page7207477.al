page 7207477 "Operative Jobs List"
{
  ApplicationArea=All;

    Editable = false;
    CaptionML = ENU = 'Operative Jobs List', ESP = 'Lista proyectos operativos';
    SourceTable = 167;
    ...
    actions
    {
        area(Navigation)
        {
            ...
            group("BtnJob")
            {
                ...
                action("Tasks")
                {
                    ...
                    trigger OnAction()
                    VAR
                        QBJobTaskData: Page 7206997;
                    BEGIN
                        CLEAR(QBJobTaskData);
                        QBJobTaskData.SetJob(Rec."No.");
                        QBJobTaskData.RUNMODAL;
                    END;
                ...
                action("action10")
                {
                    CaptionML = ENU = 'EOC (excel)', ESP = 'OEC (excel)';
            ...
            group("group31")
            {
                ...
                action("action26")
                {
                    CaptionML = ENU = 'Assigned Certifiaction', ESP = 'Agr. de coste';
                    Enabled = BtnAgrupacionesEnabled;
                    Image = LotInfo;
        ...
        area(Promoted)
        {
            ...
            group(Category_Process)
            {
                ...
                actionref(Job_Schema_Promoted; Job_Schema)
                {
                }
    ...
    BEGIN
        ...
        //JAV 18/05/22: - QB 1.10.42 Report visible solo para KALAM
        seeKALAM := FunctionQB.IsClient('KAL');
    END;
    ...
    BEGIN
        ...
        //CurrPage.UPDATE(FALSE); //Refrresco +++
    END;
    ...
    var
        ...
        seeDragDrop: Boolean;
        vObralia: Boolean;
        BtnAgrupacionesEnabled: Boolean;
        seeKALAM: Boolean;
        "--------------------------------------- Divisas": Integer;
    ...
    begin
        ...
        //JAV 31/10/20: - QB 1.07.03 Agrupaciones de coste
        BtnAgrupacionesEnabled := rec."Separation Job Unit/Cert. Unit";
        //JAV 31/10/20: - QB 1.07.03 Agrupaciones de coste
    ...
    /*{
      ...
      MMS 08/07/21: - (Q13639) Crear bot�n "Ver Agrupado" para mostrar los valores agrupados de proyectos Padre-Hijo
