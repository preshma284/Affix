page 7207640 "RC Jefe Obra"
{
    CaptionML = ENU = 'CO Role Center', ESP = 'Jefe de Obra';
    PageType = RoleCenter;
    layout
    {
        area(RoleCenter)
    ...
    actions
    {
        ...
        area(Embedding)
        {
            ...
            action("action10")
            {
                CaptionML = ENU = 'Operative Matrix Jobs', ESP = 'Proyectos Matriz operativos';
                RunObject = Page 7206989;
            }
            action("action11")
            {
    ...
    /*
      ...
      begin
      {
        //PSM 20114 A�adir page 50005 Lista proyectos operativos Agregados (ROIG) en PageAction
      }
      end.*/
