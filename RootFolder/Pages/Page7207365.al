page 7207365 "Archived Quotes List"
{
  ApplicationArea=All;

    Editable = false;
    CaptionML = ENU = 'Quotes List Archived', ESP = 'Lista ofertas Archivadas';
    SourceTable = 167;
    SourceTableView = SORTING("No.")
                    ORDER(Descending)
                    WHERE("Card Type" = FILTER("Estudio"), "Original Quote Code" = FILTER(''), "Archived" = CONST(true));
    PageType = List;
