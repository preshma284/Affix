page 7207093 "RE Active List Archived"
{
  ApplicationArea=All;

    Editable = false;
    CaptionML = ENU = 'Real Estate Active Lis tArchived', ESP = 'Lista de Activos Inmobiliarios Archivados';
    SourceTable = 167;
    SourceTableView = SORTING("No.")
                    ORDER(Descending)
                    WHERE("Card Type" = FILTER("Promocion"), "Archived" = CONST(true));
    PageType = List;
    ...
    /*{
      ...
      JAV 01/06/22: - QB 1.10.46 Se corrige el texto err�neo en la columna "Realizado" en los proyectos inmobiliarios
    }*///end
}
