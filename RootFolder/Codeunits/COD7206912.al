Codeunit 7206912 "Approval Purchase Order"
{
    ...
    BEGIN
        ...
        IF Rec.Status = Rec.Status::"Pending Approval" THEN
            ERROR(Text003);
        Reopen(Rec);
        //-17704 10/08/22: - QB 1.11.01 Se lanza el evento a reabrir el documento
    ...
    BEGIN
        ...
        IF (RecRef.NUMBER = GetTableNumber) THEN BEGIN
            RecRef.SETTABLE(Rec);
            IF (Rec."Document Type" = Rec."Document Type"::Order) THEN BEGIN  //Hay varios tipos de documento en la misma tabla
    ...
    BEGIN
        ...
        IF (RecRef.NUMBER = GetTableNumber) THEN BEGIN
            ...
            IF (Rec."Document Type" = Rec."Document Type"::Order) THEN BEGIN  //Hay varios tipos de documento en la misma tabla
                ...
                ApprovalEntryArgument.Type := 'Pedido compra';
    ...
    // [EventSubscriber(ObjectType::Report, 1320, 1320, '', true, true)]
    ...
    BEGIN
        ...
        EXIT(ApprovalEntry."QB Document Type"::Purchase);
    END;
    ...
    BEGIN
        ...
        EXIT(QBApprovalManagement.GetApprovalsFixedText(pType, 'PEDIDOCOMPRA', 'un pedido de compra'));
    END;
    ...
    BEGIN
        IF (PurchHeader."Document Type" = PurchHeader."Document Type"::Order) THEN  //Hay varios tipos de documento en la misma tabla
    ...
    BEGIN
        //JAV 20/05/22: - QB 1.10.41 Se cambia la variable para el proyecto y partida de aprobaci�n
        IF (Rec."Document Type" = Rec."Document Type"::Order) THEN  //Hay varios tipos de documento en la misma tabla
            SetApprovalCircuit(Rec);
    END;
    ...
    /*{
          ...
          DGG 18/07/22: - QB 17704 Se publica evento OnAfterPerformManualReopenDoc.
