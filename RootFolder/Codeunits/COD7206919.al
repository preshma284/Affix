Codeunit 7206919 "Approval Expense Notes"
{
    ...
    //[IntegrationEvent]
    PROCEDURE OnAfterSendApproval(VAR Rec: Record 7207320);
    BEGIN
    END;

    //[IntegrationEvent]
    PROCEDURE OnAfterReleaseDocument(VAR Rec: Record 7207320);
    BEGIN
    END;

    //[IntegrationEvent]
    PROCEDURE OnAfterReopenDocument(VAR Rec: Record 7207320);
    BEGIN
    END;

    //[IntegrationEvent]
    PROCEDURE OnAfterPerformManualReopenDoc(VAR Rec: Record 7207320);
    BEGIN
    END;
    ...
    PROCEDURE Release(VAR Rec: Record 7207320);
    BEGIN
    ...
    PROCEDURE Reopen(VAR Rec: Record 7207320);
    BEGIN
    ...
    PROCEDURE PerformManualRelease(VAR Rec: Record 7207320);
    VAR
    ...
    PROCEDURE PerformManualReopen(VAR Rec: Record 7207320);
    VAR
    ...
    PROCEDURE SetApprovalsControls(Rec: Record 7207320; VAR ApprovalsActive: Boolean; VAR OpenApprovalEntriesExistForCurrUser: Boolean; VAR CanRequestApproval: Boolean; VAR CanCancelApproval: Boolean; VAR CanRelease: Boolean; VAR CanReopen: Boolean);
    VAR
    ...
    PROCEDURE ViewApprovals(Rec: Record 7207320);
    VAR
    ...
    PROCEDURE SendApproval(Rec: Record 7207320);
    VAR
    ...
    PROCEDURE CancelApproval(Rec: Record 7207320);
    VAR
        WorkflowManagement: Codeunit 1501;
        WorkflowWebhookMgt: Codeunit 1543;
    BEGIN
    ...
    PROCEDURE WitHoldingApproval(Rec: Record 7207320);
    VAR
        QBApprovalManagement: Codeunit 7207354;
    ...
    BEGIN
        ...
        IF (RecRef.NUMBER = GetTableNumber) THEN BEGIN
            ...
            IF (TRUE) THEN BEGIN  //No hay varios tipos de documento en la misma tabla
                ...
                ApprovalEntryArgument.Type := 'Nota de gastos';
        ...
        IF (RecRef.NUMBER = GetTableNumber) THEN BEGIN
            ...
            IF (TRUE) THEN BEGIN  //No hay varios tipos de documento en la misma tabla
                ...
                END ELSE BEGIN
                    ...
                    IF NOT Employee.GET(Rec.Employee) THEN
                        Employee.INIT;

                    Field1Label := 'Importe';
                    Field1Value := FORMAT(Amount);
                    Field2Label := Rec.FIELDCAPTION(Employee);
                    ;
                    Field2Value := '(' + FORMAT(Rec.Employee) + ') ' + Employee.Name;
                END;
            END;
    ...
    PROCEDURE IsApprovalsWorkflowEnabled(VAR Rec: Record 7207320): Boolean;
    VAR
        WorkflowManagement: Codeunit 1501;
    BEGIN
    ...
    PROCEDURE CheckApprovalPossible(VAR Rec: Record 7207320): Boolean;
    VAR
    ...
    PROCEDURE PrePostApprovalCheck(VAR Rec: Record 7207320): Boolean;
    VAR
    ...
    BEGIN
        ...
        EXIT(QBApprovalManagement.GetApprovalsFixedText(pType, 'NOTAGASTO', 'una nota de gastos'));
    END;
    ...
    LOCAL PROCEDURE SetApprovalCircuit(VAR Rec: Record 7207320);
    VAR
        QBApprovalManagement: Codeunit 7207354;
        RecRef: RecordRef;
    BEGIN
    ...
    LOCAL PROCEDURE CheckAdditionalConditions(Rec: Record 7207320);
    BEGIN
    ...
    [EventSubscriber(ObjectType::Table, 7207320, OnAfterValidateEvent, "Job No.", true, true)]
    LOCAL PROCEDURE T7207320_OnAfterValidateEvent_JobNo(VAR Rec: Record 7207320; VAR xRec: Record 7207320; CurrFieldNo: Integer);
    BEGIN
