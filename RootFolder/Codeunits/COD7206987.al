Codeunit 7206987 "QB Withholding Apr"
{
    ...
    //[IntegrationEvent]
    PROCEDURE OnAfterSendApproval(VAR Rec: Record 7207329);
    BEGIN
    END;

    //[IntegrationEvent]
    PROCEDURE OnAfterReleaseDocument(VAR Rec: Record 7207329);
    BEGIN
    END;

    //[IntegrationEvent]
    PROCEDURE OnAfterReopenDocument(VAR Rec: Record 7207329);
    BEGIN
    END;

    //[IntegrationEvent]
    PROCEDURE OnAfterPerformManualReopenDoc(VAR Rec: Record 7207329);
    BEGIN
    END;
    ...
    PROCEDURE Release(VAR Rec: Record 7207329);
    BEGIN
    ...
    PROCEDURE Reopen(VAR Rec: Record 7207329);
    BEGIN
    ...
    PROCEDURE PerformManualRelease(VAR Rec: Record 7207329);
    VAR
    ...
    PROCEDURE PerformManualReopen(VAR Rec: Record 7207329);
    VAR
    ...
    PROCEDURE SetApprovalsControls(Rec: Record 7207329; VAR ApprovalsActive: Boolean; VAR OpenApprovalEntriesExistForCurrUser: Boolean; VAR CanRequestApproval: Boolean; VAR CanCancelApproval: Boolean; VAR CanRelease: Boolean; VAR CanReopen: Boolean);
    VAR
    ...
    PROCEDURE ViewApprovals(Rec: Record 7207329);
    VAR
    ...
    PROCEDURE SendApproval(Rec: Record 7207329);
    VAR
    ...
    PROCEDURE CancelApproval(Rec: Record 7207329);
    VAR
        WorkflowManagement: Codeunit 1501;
        WorkflowWebhookMgt: Codeunit 1543;
    BEGIN
    ...
    PROCEDURE WitHoldingApproval(Rec: Record 7207329);
    VAR
        QBApprovalManagement: Codeunit 7207354;
    ...
    BEGIN
        ...
        IF (RecRef.NUMBER = GetTableNumber) THEN BEGIN
            ...
            IF (TRUE) THEN BEGIN  //No hay varios tipos de documento en la misma tabla
                ...
                ApprovalEntryArgument.Type := 'Retenci�n';
        ...
        IF (RecRef.NUMBER = GetTableNumber) THEN BEGIN
            ...
            IF (TRUE) THEN BEGIN  //No hay varios tipos de documento en la misma tabla
                ...
                END ELSE BEGIN
                    ...
                    Field2Label := Rec.FIELDCAPTION("No.");
                    Field2Value := FORMAT(Rec."No.");
                END;
            END;
    ...
    PROCEDURE IsApprovalsWorkflowEnabled(VAR Rec: Record 7207329): Boolean;
    VAR
        WorkflowManagement: Codeunit 1501;
    BEGIN
    ...
    PROCEDURE CheckApprovalPossible(VAR Rec: Record 7207329): Boolean;
    VAR
    ...
    PROCEDURE PrePostApprovalCheck(VAR Rec: Record 7207329): Boolean;
    VAR
    ...
    BEGIN
        ...
        EXIT(QBApprovalManagement.GetApprovalsFixedText(pType, 'RETENCION', 'una retenci�n'));
    END;
    ...
    LOCAL PROCEDURE SetApprovalCircuit(VAR Rec: Record 7207329);
    VAR
        QBApprovalManagement: Codeunit 7207354;
        RecRef: RecordRef;
    BEGIN
    ...
    LOCAL PROCEDURE CheckAdditionalConditions(Rec: Record 7207329);
    BEGIN
    ...
    [EventSubscriber(ObjectType::Table, 7207329, OnAfterValidateEvent, "QB Approval Job No", true, true)]
    LOCAL PROCEDURE T7207329_OnAfterValidateEvent_JobNo(VAR Rec: Record 7207329; VAR xRec: Record 7207329; CurrFieldNo: Integer);
    BEGIN
        IF (TRUE) THEN  //No hay varios tipos de documento en la misma tabla
            SetApprovalCircuit(Rec);
    END;

    [EventSubscriber(ObjectType::Table, 7207329, OnAfterValidateEvent, "QB Approval Budget item", true, true)]
    LOCAL PROCEDURE T7207329_OnAfterValidateEvent_Budgetitem(VAR Rec: Record 7207329; VAR xRec: Record 7207329; CurrFieldNo: Integer);
    BEGIN
    ...
    /*BEGIN
/*{
      JAV 13/12/22: - QB 1.12.26 Nuevo circuito de aprobaci�n para retenciones
    }
END.*/
}
