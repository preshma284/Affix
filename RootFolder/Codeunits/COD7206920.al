Codeunit 7206920 "Approval Worksheet"
{
    ...
    //[IntegrationEvent]
    PROCEDURE OnAfterSendApproval(VAR Rec: Record 7207290);
    BEGIN
    END;

    //[IntegrationEvent]
    PROCEDURE OnAfterReleaseDocument(VAR Rec: Record 7207290);
    BEGIN
    END;

    //[IntegrationEvent]
    PROCEDURE OnAfterReopenDocument(VAR Rec: Record 7207290);
    BEGIN
    END;

    //[IntegrationEvent]
    PROCEDURE OnAfterPerformManualReopenDoc(VAR Rec: Record 7207290);
    BEGIN
    END;
    ...
    PROCEDURE Release(VAR Rec: Record 7207290);
    BEGIN
    ...
    PROCEDURE Reopen(VAR Rec: Record 7207290);
    BEGIN
    ...
    PROCEDURE PerformManualRelease(VAR Rec: Record 7207290);
    VAR
    ...
    PROCEDURE PerformManualReopen(VAR Rec: Record 7207290);
    VAR
    ...
    PROCEDURE SetApprovalsControls(Rec: Record 7207290; VAR ApprovalsActive: Boolean; VAR OpenApprovalEntriesExistForCurrUser: Boolean; VAR CanRequestApproval: Boolean; VAR CanCancelApproval: Boolean; VAR CanRelease: Boolean; VAR CanReopen: Boolean);
    VAR
    ...
    PROCEDURE ViewApprovals(Rec: Record 7207290);
    VAR
    ...
    PROCEDURE SendApproval(Rec: Record 7207290);
    VAR
    ...
    PROCEDURE CancelApproval(Rec: Record 7207290);
    VAR
        WorkflowManagement: Codeunit 1501;
        WorkflowWebhookMgt: Codeunit 1543;
    BEGIN
    ...
    PROCEDURE WitHoldingApproval(Rec: Record 7207290);
    VAR
        QBApprovalManagement: Codeunit 7207354;
    ...
    BEGIN
        ...
        IF (RecRef.NUMBER = GetTableNumber) THEN BEGIN
            ...
            IF (TRUE) THEN BEGIN  //No hay varios tipos de documento en la misma tabla
                ...
                ApprovalEntryArgument.Type := 'Hoja de Horas';
        ...
        IF (RecRef.NUMBER = GetTableNumber) THEN BEGIN
            ...
            IF (TRUE) THEN BEGIN  //No hay varios tipos de documento en la misma tabla
                ...
                END ELSE BEGIN
                    ...
                    Field2Label := FORMAT(Rec."Sheet Type");
                    Field2Value := FORMAT(Rec."No. Resource /Job");
                END;
            END;
    ...
    PROCEDURE IsApprovalsWorkflowEnabled(VAR Rec: Record 7207290): Boolean;
    VAR
        WorkflowManagement: Codeunit 1501;
    BEGIN
    ...
    PROCEDURE CheckApprovalPossible(VAR Rec: Record 7207290): Boolean;
    VAR
    ...
    PROCEDURE PrePostApprovalCheck(VAR Rec: Record 7207290): Boolean;
    VAR
    ...
    BEGIN
        ...
        EXIT(QBApprovalManagement.GetApprovalsFixedText(pType, 'HOJAHORAS', 'una hoja de horas'));
    END;
    ...
    LOCAL PROCEDURE SetApprovalCircuit(VAR Rec: Record 7207290);
    VAR
        QBApprovalManagement: Codeunit 7207354;
        RecRef: RecordRef;
    BEGIN
    ...
    LOCAL PROCEDURE CheckAdditionalConditions(Rec: Record 7207290);
    BEGIN
    ...
    [EventSubscriber(ObjectType::Table, 7207290, OnAfterValidateEvent, "Job No.", true, true)]
    LOCAL PROCEDURE T7207290_OnAfterValidateEvent_JobNo(VAR Rec: Record 7207290; VAR xRec: Record 7207290; CurrFieldNo: Integer);
    BEGIN
