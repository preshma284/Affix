Codeunit 7206928 "Approval Purchase CrMemo"
{
    ...
    BEGIN
        ...
        IF (RecRef.NUMBER = GetTableNumber) THEN BEGIN
            RecRef.SETTABLE(Rec);
            IF (Rec."Document Type" = Rec."Document Type"::"Credit Memo") THEN BEGIN  //Hay varios tipos de documento en la misma tabla
    ...
    BEGIN
        ...
        IF (RecRef.NUMBER = GetTableNumber) THEN BEGIN
            ...
            IF (Rec."Document Type" = Rec."Document Type"::"Credit Memo") THEN BEGIN  //Hay varios tipos de documento en la misma tabla
                ...
                ApprovalEntryArgument.Type := 'Abono compra';
    ...
    BEGIN
        ...
        EXIT(ApprovalEntry."QB Document Type"::PurchaseCredirMemo);
    END;
    ...
    BEGIN
        ...
        EXIT(QBApprovalManagement.GetApprovalsFixedText(pType, 'ABONOCOMPRA', 'un abono de compra'))
    END;
