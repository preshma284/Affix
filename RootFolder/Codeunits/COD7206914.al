Codeunit 7206914 "Approval Measurements"
{
    ...
    //[IntegrationEvent]
    PROCEDURE OnAfterSendApproval(VAR Rec: Record 7207336);
    BEGIN
    END;

    //[IntegrationEvent]
    PROCEDURE OnAfterReleaseDocument(VAR Rec: Record 7207336);
    BEGIN
    END;

    //[IntegrationEvent]
    PROCEDURE OnAfterReopenDocument(VAR Rec: Record 7207336);
    BEGIN
    END;

    //[IntegrationEvent]
    PROCEDURE OnAfterPerformManualReopenDoc(VAR Rec: Record 7207336);
    BEGIN
    END;
    ...
    PROCEDURE Release(VAR Rec: Record 7207336);
    BEGIN
    ...
    PROCEDURE Reopen(VAR Rec: Record 7207336);
    BEGIN
    ...
    PROCEDURE PerformManualRelease(VAR Rec: Record 7207336);
    VAR
    ...
    PROCEDURE PerformManualReopen(VAR Rec: Record 7207336);
    VAR
    ...
    PROCEDURE SetApprovalsControls(Rec: Record 7207336; VAR ApprovalsActive: Boolean; VAR OpenApprovalEntriesExistForCurrUser: Boolean; VAR CanRequestApproval: Boolean; VAR CanCancelApproval: Boolean; VAR CanRelease: Boolean; VAR CanReopen: Boolean);
    VAR
    ...
    PROCEDURE ViewApprovals(Rec: Record 7207336);
    VAR
    ...
    PROCEDURE SendApproval(Rec: Record 7207336);
    VAR
    ...
    PROCEDURE CancelApproval(Rec: Record 7207336);
    VAR
        WorkflowManagement: Codeunit 1501;
        WorkflowWebhookMgt: Codeunit 1543;
    BEGIN
    ...
    PROCEDURE WitHoldingApproval(Rec: Record 7207336);
    VAR
        QBApprovalManagement: Codeunit 7207354;
    ...
    BEGIN
        ...
        IF (RecRef.NUMBER = GetTableNumber) THEN BEGIN
            ...
            IF (TRUE) THEN BEGIN  //No hay varios tipos de documento en la misma tabla
                ...
                ApprovalEntryArgument.Type := 'Medici�n';
        ...
        IF (RecRef.NUMBER = GetTableNumber) THEN BEGIN
            ...
            IF (TRUE) THEN BEGIN  //No hay varios tipos de documento en la misma tabla
                ...
                END ELSE BEGIN
                    ...
                    Field2Label := 'Cliente';
                    Field2Value := Rec.Name + ' (#' + FORMAT(Rec."Customer No.") + ')';
                END;
            END;
    ...
    PROCEDURE IsApprovalsWorkflowEnabled(VAR Rec: Record 7207336): Boolean;
    VAR
        WorkflowManagement: Codeunit 1501;
    BEGIN
    ...
    PROCEDURE CheckApprovalPossible(VAR Rec: Record 7207336): Boolean;
    VAR
    ...
    PROCEDURE PrePostApprovalCheck(VAR Rec: Record 7207336): Boolean;
    VAR
    ...
    BEGIN
        ...
        EXIT(QBApprovalManagement.GetApprovalsFixedText(pType, 'MEDICION', 'una medici�n/certificaci�n'));
    END;
    ...
    LOCAL PROCEDURE SetApprovalCircuit(VAR Rec: Record 7207336);
    VAR
        QBApprovalManagement: Codeunit 7207354;
        RecRef: RecordRef;
    BEGIN
    ...
    LOCAL PROCEDURE CheckAdditionalConditions(Rec: Record 7207336);
    BEGIN
    ...
    [EventSubscriber(ObjectType::Table, 7207336, OnAfterValidateEvent, "Job No.", true, true)]
    LOCAL PROCEDURE T7207336_OnAfterValidateEvent_JobNo(VAR Rec: Record 7207336; VAR xRec: Record 7207336; CurrFieldNo: Integer);
    BEGIN
